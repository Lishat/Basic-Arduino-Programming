...
String name="<p>ITWS</p>";   //22
String dat="<p>WIFI DAATA SEND </p>";     //21
...
void wifi_init(){
      ...
      if(!No_IP)
      {
        ...
        connect_wifi("AT+CWJAP=\"ComputerLab1\",\"lab1@iiits85\"",7000);         //provide your WiFi username and password here
...
void Send(){
  ...
  Serial.println(voltage);
      webpage = "<h1>WIFI DATA SENDING(RANDOM VALUES ARE USED)</h1>";
      sendwebdata(webpage);
      webpage=name;
      webpage+=dat+voltage;
      sendwebdata(webpage);
